        ...
        <div className="flex flex-col flex-1 px-1">
          ...
          <div className="flex items-center gap-2 mb-4 text-gray-400 group-hover:text-orange-400 transition-colors">
            ...
            <p className="text-xs font-bold truncate">
              {service.detail_1 || (service.pickup_address as any)?.address_detail || "Location provided on request"}
            </p>
          </div>
          ...
          <div className="mt-auto pt-5 border-t border-orange-50 flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-[10px] font-black text-orange-300 uppercase tracking-widest mb-0.5">Price</span>
